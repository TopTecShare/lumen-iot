                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        ...
                                        class="edit"
                                        data-toggle="modal"
                                        onclick="edit('{{$user->name}}, {{$user->email}}, {{$user->role}}, {{$user->password}}, {{$user->id}}')"
                                        ><i
        ...
        <script>
            $(document).ready(function () {
                jQuery.validator.addMethod(
                    ...
                    "Please enter correct user role(admin or user)!"
                );
                $(".datatable").DataTable({
                    language: {
            ...
            const edit = (user) => {
                ...
                $("#editUserModal")
                    ...
                    .val(user[3]);
                $("#editUserModal").find('input[name="id"]').val(user[4]);
            };
            const del = (email) => {
